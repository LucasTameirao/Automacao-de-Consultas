from selenium import webdriver # modulo para automações na web, usando o navegador
...
caminho_planilha = './dados_consulta.xlsx' # variavel para facilitar o acesso ao caminho da planilha.xlsx
